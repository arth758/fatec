...
def near_ten(n):
  distancia = n % 10
  if distancia <= 2 or distancia == 8 or distancia == 9:
    return True
  return False
...
def count_code(s):
  import string
  soma = 0
  for str in string.ascii_lowercase:
    soma += s.count('co' + str + 'e')
  return soma
