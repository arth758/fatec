...
def mistura2(a, b):
  list_a = a
  list_b = b
  a = a.replace(a[0], list_b[0])
  a = a.replace(a[1], list_b[1])
  b = b.replace(b[0], list_a[0])
  b = b.replace(b[1], list_a[1])
  saida = a + ' ' + b
  return saida
